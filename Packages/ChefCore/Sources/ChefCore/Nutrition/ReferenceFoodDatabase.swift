...
public struct ReferenceFood: Identifiable, Sendable, Equatable {
    ...
    public init(name: String, unit: PortionUnit = .g, per100: NutritionFacts) {
        self.name = name
        self.unit = unit
        self.per100 = per100
    }
...
/// dependência de rede — o app funciona sem internet.
public enum ReferenceFoodDatabase {
    ...
    public static let all: [ReferenceFood] = [
        ...
        food("Linguiça", cal: 300, p: 13, c: 3, f: 27),
        food("Contra filé grelhado", cal: 250, p: 26, c: 0, f: 16),
        food("Peito de frango grelhado", cal: 165, p: 31, c: 0, f: 3.6),
        food("Coxa de frango", cal: 209, p: 26, c: 0, f: 10.9),
        food("Carne moída", cal: 215, p: 26, c: 0, f: 12),
        food("Picanha grelhada", cal: 289, p: 25, c: 0, f: 21),
        food("Alcatra grelhada", cal: 200, p: 27, c: 0, f: 10),
        food("Bacon", cal: 541, p: 37, c: 1.4, f: 42),
        food("Bisteca suína", cal: 231, p: 27, c: 0, f: 13),
        food("Salmão grelhado", cal: 208, p: 20, c: 0, f: 13),
        food("Tilápia grelhada", cal: 96, p: 20, c: 0, f: 1.7),
        food("Atum em água", cal: 116, p: 26, c: 0, f: 1),
        food("Camarão", cal: 99, p: 24, c: 0.2, f: 0.3),
        food("Ovo cozido", cal: 155, p: 13, c: 1.1, f: 11),
        food("Presunto", cal: 145, p: 21, c: 1.5, f: 5),
        food("Mortadela", cal: 269, p: 12, c: 3, f: 24),
        food("Peito de peru", cal: 135, p: 24, c: 3, f: 3),
        food("Costela bovina", cal: 275, p: 24, c: 0, f: 19),
        food("Fígado bovino", cal: 135, p: 20, c: 3.9, f: 3.6),

        // MARK: Carboidratos
        food("Batata inglesa cozida", cal: 87, p: 1.9, c: 20, f: 0.1),
        food("Batata doce cozida", cal: 86, p: 1.6, c: 20, f: 0.1),
        ...
        food("Pão francês", cal: 300, p: 8, c: 58, f: 3),
        food("Pão de forma", cal: 266, p: 9, c: 49, f: 3.3),
        food("Pão integral", cal: 247, p: 13, c: 41, f: 3.4),
        ...
        // MARK: Frutas
        food("Banana", cal: 89, p: 1.1, c: 23, f: 0.3),
        food("Maçã", cal: 52, p: 0.3, c: 14, f: 0.2),
        food("Laranja", cal: 47, p: 0.9, c: 12, f: 0.1),
        food("Mamão", cal: 43, p: 0.5, c: 11, f: 0.3),
        food("Abacate", cal: 160, p: 2, c: 8.5, f: 15),
        food("Morango", cal: 32, p: 0.7, c: 7.7, f: 0.3),
        food("Manga", cal: 60, p: 0.8, c: 15, f: 0.4),
        ...
        food("Queijo mussarela", cal: 280, p: 22, c: 2.2, f: 21),
        ...
        food("Castanha do pará", cal: 656, p: 14, c: 12, f: 66),
    ...
    private static func food(_ name: String, unit: PortionUnit = .g, cal: Double, p: Double, c: Double, f: Double) -> ReferenceFood {
        ReferenceFood(name: name, unit: unit, per100: NutritionFacts(calories: cal, protein: p, carbs: c, fat: f))
    }
}
